...
import testcase.Img;
	...
	public class ImgCode {
		public static void getImgCode(WebDriver dr,WebElement img) throws InterruptedException, IOException{
			 try{ 
			if(img!=null){  	                 
	              String src =  img.getAttribute("src");
	              System.out.println("src======="+src);
	               if(src!=null && !"".equals(src)){  
	                   BufferedImage inputbig = IoAction.createElementImage(dr,img);  
	                   Thread.sleep(3000);
